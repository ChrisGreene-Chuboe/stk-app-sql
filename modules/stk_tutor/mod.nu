...
export def "stk tutor ops" [] {r#' 
Learn to use chuck-stack for business operations.
'#
 | nu-light 
}

export def "stk tutor ops begin" [] {r#' 
...
export def "stk tutor ops customer" [] {r#' 
...
export def "stk tutor ops vendor" [] {r#' 
...
export def "stk tutor dev" [] {r#' 
Learn to extend chuck-stack with new capabilities.
'#
 | nu-light 
}

export def "stk tutor dev begin" [] {r#' 
...
export def "stk tutor dev patterns" [] {r#' 
