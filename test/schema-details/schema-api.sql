...
CREATE VIEW api.stk_attribute_tag_type AS
 SELECT stk_attribute_tag_type_uu,
    ...
    is_active,
    is_default,
    stk_attribute_tag_type_enum,
    search_key,
    name,
    description,
    stk_attribute_tag_type_json
...
CREATE VIEW api.stk_statistic_type AS
 SELECT stk_statistic_type_uu,
    ...
    updated_by_uu,
    is_active,
    stk_statistic_type_enum,
    search_key,
    name,
    description,
    stk_statistic_type_json
...
CREATE VIEW api.stk_stk_abbreviation AS
 SELECT stk_stk_abbreviation_uu,
    created,
    created_by_uu,
    updated,
    updated_by_uu,
    ...
    name,
    description
   FROM private.stk_stk_abbreviation;
...
CREATE VIEW api.stk_system_config_type AS
 SELECT stk_system_config_type_uu,
    ...
    updated_by_uu,
    is_active,
    stk_system_config_type_enum,
    search_key,
    name,
    description,
    stk_system_config_type_json
