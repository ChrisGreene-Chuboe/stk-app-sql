...
assert (($created | describe | str starts-with "record")) "Should create bp"
...
let revoke_string = ($revoke_item.uu | bp revoke)
...
let revoke_param = (bp revoke --uu $revoke_item2.uu)
...
let revoke_record = ($revoke_item3 | bp revoke)
...
let json_detail = ($json_created.uu | bp get)
...
let no_json_detail = ($no_json.uu | bp get)
...
let complex_detail = ($complex_created.uu | bp get)
...
let revoked = ($revoked_template.uu | bp revoke)
...
let get_template = ($template.uu | bp get)
